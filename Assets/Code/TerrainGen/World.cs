...
public class World : MonoBehaviour
{
    ...
    private Vector2 _currentViewerCoords = Vector2.one;
    public Vector2 currentViewerCoords
    {
        get { return _currentViewerCoords; }

        private set
        {
            if (_currentViewerCoords != value)
                OnViewerChunkEnter(value);

            _currentViewerCoords = value;
        }
    }
    ...
    void Start()
    {
        ...
        _viewerTransform = Camera.main.transform.parent;
    }
    ...
    private void DeleteChunks()
    {
        while (_chunksToRemoveCoordsQueue.Count > 0)
        {
            ...
            Destroy(_worldChunks[_chunksToRemoveCoordsQueue[0]].gameObject.GetComponent<MeshFilter>().mesh); 
    ...
    private void OnViewerChunkEnter(Vector2 inToChunk)
    {
